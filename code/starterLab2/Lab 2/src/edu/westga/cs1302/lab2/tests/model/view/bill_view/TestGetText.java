...
public class TestGetText {
	...
	bill.addItem(item3);
	var result = generator.getText(bill);
	var expected = "ITEMS" + System.lineSeparator() +  "Batteries - 5.0" + System.lineSeparator() +  "Doritos - 7.0" + System.lineSeparator() +  "Toaster - 14.0" + System.lineSeparator() + System.lineSeparator()  
			+ "SUBTOTAL - $26.0" + System.lineSeparator() + "TAX - $2.6" + System.lineSeparator()  
			+ "TIP - $5.2" + System.lineSeparator() + "TOTAL - $33.8";
	assertEquals(result, expected);
