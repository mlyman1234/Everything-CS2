...
public class Task implements Comparable<Task> {
	...
	public int taskPriorityToInt() {
		int taskValue = 0;
		
		if(this.getPriority() == TaskPriority.HIGH) {
			taskValue = 3;
		}
		else if(this.getPriority() == TaskPriority.MEDIUM) {
			taskValue = 2;
		}
		else if(this.getPriority() == TaskPriority.LOW) {
			taskValue = 1;
		}
		return taskValue;
	}
	...
	public int compareTo(Task o) {
		return new TaskComparatorAscending().compare(this, o);
	}
}
