...
public class TestSubtotalCalculator {

	@Test
	void testSubtotalCalcualtor() {
		Bill bill = new Bill();
		...
		var result = BillCalculator.subtotalCalculator(items);
		var expected = 4.0;
	...
	void testIfNullValuesAreFound() {
		...
		assertThrows(IllegalArgumentException.class, () -> {
			BillCalculator.subtotalCalculator(items);
		});
	}
}
